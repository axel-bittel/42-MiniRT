...
# FOR MAC
	gcc -Wall -Werror -Wextra $(ARG) -Llibft -lft -Llib_visual/minilibx -lmlx $(OLIBVISUAL) -framework OpenGL -framework AppKit ${OBSRCS} -o $(NAME) -g
# FOR LINUX
...
# FOR MAC
	gcc -Wall -Werror -Wextra $(ARG)  -Llibft -lft -Llib_visual/minilibx -lmlx $(OLIBVISUAL) -framework OpenGL -framework AppKit ${OSRCS} -o $(NAME) -g
# FOR LINUX
